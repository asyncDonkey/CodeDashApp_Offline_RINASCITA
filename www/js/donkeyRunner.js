...
const soundsToLoad = [
    ...
    { name: 'sfx_menu_eat', path: 'audio/sfx_menu_eat.ogg' },
    { name: 'sfx_donkey_digest', path: 'audio/sfx_donkey_digest.ogg' },
    { name: 'sfx_donkey_comment', path: 'audio/sfx_donkey_comment.ogg' },
