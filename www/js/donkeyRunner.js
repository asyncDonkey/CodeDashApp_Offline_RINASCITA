...
// --- GESTIONE AUDIO V1.4 ---
const BGM_PLAYLIST = Array.from(
  { length: 11 },
  (_, i) => `track_${String(i + 1).padStart(2, '0')}.ogg`,
);
...
export const SKIN_ASSET_MAP = {
  skin_donkey_default_info: {
    // This is now a purchasable skin, not just "default"
...
const PLAYER_PROJECTILE_TARGET_WIDTH =
  PLAYER_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const PLAYER_PROJECTILE_TARGET_HEIGHT =
  PLAYER_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const MACHINE_LANGUAGE_PROJECTILE_TARGET_WIDTH =
  MACHINE_LANGUAGE_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const MACHINE_LANGUAGE_PROJECTILE_TARGET_HEIGHT =
  MACHINE_LANGUAGE_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const RAIN_PROJECTILE_TARGET_WIDTH =
  RAIN_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const RAIN_PROJECTILE_TARGET_HEIGHT =
  RAIN_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const ENEMY_FOUR_PROJECTILE_TARGET_WIDTH =
  ENEMY_FOUR_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const ENEMY_FOUR_PROJECTILE_TARGET_HEIGHT =
  ENEMY_FOUR_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const ENEMY_SIX_PROJECTILE_TARGET_WIDTH =
  ENEMY_SIX_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const ENEMY_SIX_PROJECTILE_TARGET_HEIGHT =
  ENEMY_SIX_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const DANGEROUS_FLYING_ENEMY_TARGET_HEIGHT =
  DANGEROUS_FLYING_ENEMY_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const KAMIKAZE_FLYING_ENEMY_TARGET_WIDTH =
  KAMIKAZE_FLYING_ENEMY_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR; // [FEAT] Dimensioni target
const KAMIKAZE_FLYING_ENEMY_TARGET_HEIGHT =
  KAMIKAZE_FLYING_ENEMY_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR; // [FEAT] Dimensioni target
...
const GLITCHZILLA_PROJECTILE_TARGET_WIDTH =
  GLITCHZILLA_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const GLITCHZILLA_PROJECTILE_TARGET_HEIGHT =
  GLITCHZILLA_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const GLITCHZILLA_SPECIAL_PROJECTILE_TARGET_WIDTH =
  GLITCHZILLA_SPECIAL_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR; // [FEAT] Dimensione finale
const GLITCHZILLA_SPECIAL_PROJECTILE_TARGET_HEIGHT =
  GLITCHZILLA_SPECIAL_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR; // [FEAT] Dimensione finale
...
const TROJAN_BYTE_PROJECTILE_TARGET_WIDTH =
  TROJAN_BYTE_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const TROJAN_BYTE_PROJECTILE_TARGET_HEIGHT =
  TROJAN_BYTE_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const TROJAN_BYTE_ZIGZAG_PROJECTILE_TARGET_WIDTH =
  TROJAN_BYTE_ZIGZAG_PROJECTILE_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const TROJAN_BYTE_ZIGZAG_PROJECTILE_TARGET_HEIGHT =
  TROJAN_BYTE_ZIGZAG_PROJECTILE_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const TROJAN_CHARGED_PROJECTILE_TARGET_WIDTH =
  TROJAN_CHARGED_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const TROJAN_CHARGED_PROJECTILE_TARGET_HEIGHT =
  TROJAN_CHARGED_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const MISSING_NUMBER_TARGET_WIDTH =
  MISSING_NUMBER_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR * 1.1;
const MISSING_NUMBER_TARGET_HEIGHT =
  MISSING_NUMBER_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR * 1.1;
...
const MISSING_NUMBER_ENTITY_TARGET_WIDTH =
  MISSING_NUMBER_ENTITY_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const MISSING_NUMBER_ENTITY_TARGET_HEIGHT =
  MISSING_NUMBER_ENTITY_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const MISSING_NUMBER_FAST_PROJECTILE_TARGET_WIDTH =
  MISSING_NUMBER_FAST_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const MISSING_NUMBER_FAST_PROJECTILE_TARGET_HEIGHT =
  MISSING_NUMBER_FAST_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const DUNNO_EXE_PROJECTILE_1_TARGET_WIDTH =
  DUNNO_EXE_PROJECTILE_1_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const DUNNO_EXE_PROJECTILE_1_TARGET_HEIGHT =
  DUNNO_EXE_PROJECTILE_1_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const DUNNO_EXE_PROJECTILE_2_TARGET_WIDTH =
  DUNNO_EXE_PROJECTILE_2_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const DUNNO_EXE_PROJECTILE_2_TARGET_HEIGHT =
  DUNNO_EXE_PROJECTILE_2_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const DUNNO_EXE_PROJECTILE_3_TARGET_WIDTH =
  DUNNO_EXE_PROJECTILE_3_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const DUNNO_EXE_PROJECTILE_3_TARGET_HEIGHT =
  DUNNO_EXE_PROJECTILE_3_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const SLAYER_PROJECTILE_TARGET_WIDTH =
  SLAYER_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
const SLAYER_PROJECTILE_TARGET_HEIGHT =
  SLAYER_PROJECTILE_ACTUAL_FRAME_HEIGHT * GLOBAL_SPRITE_SCALE_FACTOR;
...
const CODE_INJECTOR_PROJECTILE_TARGET_WIDTH =
  CODE_INJECTOR_PROJECTILE_ACTUAL_FRAME_WIDTH * GLOBAL_SPRITE_SCALE_FACTOR;
...
async function getAuthenticatedUserInventory() {
  ...
  try {
    ...
    console.error(
      "[donkeyRunner.js] Errore nel recuperare l'inventario utente da IndexedDB:",
      error,
    );
  }
  return null;
...
function spawnExtraLifeIfNeeded(dt) {
  ...
  if (extraLifeSpawnTimer >= nextExtraLifeSpawnTime) {
    const yPos =
      50 + Math.random() * (canvas.height - groundHeight - EXTRA_LIFE_TARGET_HEIGHT - 100);
...
function spawnRichBitsIfNeeded(dt) {
  ...
  if (richBitsSpawnTimer >= nextRichBitsSpawnTime) {
    const yPos =
      80 + Math.random() * (canvas.height - groundHeight - RICH_BITS_TARGET_HEIGHT - 120);
...
function spawnDataPackageIfNeeded(dt) {
  ...
  if (dataPackageSpawnTimer >= nextDataPackageSpawnTime) {
    const yPos =
      100 + Math.random() * (canvas.height - groundHeight - DATA_PKG_TARGET_HEIGHT - 150);
...
function spawnDigitalFruitIfNeeded(dt) {
  ...
  if (digitalFruitSpawnTimer >= nextDigitalFruitSpawnTime) {
    ...
    const yPos =
      50 + Math.random() * (canvas.height - groundHeight - DIGITAL_FRUIT_TARGET_HEIGHT - 100);
...
function fallbackShare(textToShare) {
  if (document.execCommand) {
    // navigator.clipboard.writeText non funziona sempre in WebView/iFrame
...
function prepareAssetsToLoad() {
  ...
  for (const skinId in SKIN_ASSET_MAP) {
    ...
    if (SKIN_ASSET_MAP[skinId].digest) {
      imagesToLoad.push({
        name: `playerSkin_${skinId}_digest`,
        src: SKIN_ASSET_MAP[skinId].digest,
      });
    }
    if (SKIN_ASSET_MAP[skinId].projectile) {
      imagesToLoad.push({
        name: `bulletSkin_${skinId}_projectile`,
        src: SKIN_ASSET_MAP[skinId].projectile,
      });
    }
  }
  ...
  for (const companionId in COMPANION_ASSET_MAP) {
    if (COMPANION_ASSET_MAP[companionId].sprite) {
      imagesToLoad.push({
        name: COMPANION_ASSET_MAP[companionId].sprite,
        src: COMPANION_ASSET_MAP[companionId].sprite,
      });
    }
    if (COMPANION_ASSET_MAP[companionId].projectile) {
      imagesToLoad.push({
        name: COMPANION_ASSET_MAP[companionId].projectile,
        src: COMPANION_ASSET_MAP[companionId].projectile,
      });
    }
  }
...
export function pauseGame(isNativeAppPause = false) {
  // isNativeAppPause indica se chiamata da evento App di Capacitor
...
export async function launchGame(options = {}) {
  ...
  if (!gameInventory) {
    console.warn(
      '[donkeyRunner.js] Inventario non fornito a launchGame, tentativo di recupero locale.',
    );
    gameInventory = await getAuthenticatedUserInventory(); // Recupera dal profilo locale
    if (!gameInventory) {
      console.error(
        "[donkeyRunner.js] Impossibile recuperare l'inventario locale. Avvio con inventario vuoto.",
      );
  ...
  if (companionManager) {
    // Non c'è più bisogno di controllare gameInventory qui, è già passato a resetGame
    ...
    if (equippedCompanionId) {
      ...
      console.log(
        `[donkeyRunner.js] Compagno ${equippedCompanionId} equipaggiato al lancio del gioco.`,
      );
    } else {
...
class Player {
  constructor(x, y, dw, dh, inventory = {}) {
    // 'inventory' è già il parametro
    this.x = x;
    this.y = y;
    ...
    this.digestSprite =
      images[`playerSkin_${equippedDonkeySkinId}_digest`] || images['playerDefaultDigest'];
    ...
    if (!this.digestSprite || !this.digestSprite.complete || this.digestSprite.naturalWidth === 0) {
      console.error(
        `Failed to load digest sprite for skin: ${equippedDonkeySkinId}. Using default.`,
      );
    ...
    if (
      this.reinforcedSprite &&
      this.reinforcedSprite.complete &&
      this.reinforcedSprite.naturalWidth > 0
    ) {
      this.reinforcedWalkAnimation = new SpriteAnimation(
        this.reinforcedSprite,
        PLAYER_ACTUAL_FRAME_WIDTH,
        PLAYER_ACTUAL_FRAME_HEIGHT,
        PLAYER_NUM_WALK_FRAMES,
    ...
    this.digestAnimation = new SpriteAnimation(
      this.digestSprite,
      PLAYER_ACTUAL_FRAME_WIDTH,
      PLAYER_ACTUAL_FRAME_HEIGHT,
      PLAYER_DIGEST_NUM_FRAMES,
    );

    this.reinforcedDigestSprite = images['playerReinforcedDigest'];
    this.reinforcedDigestAnimation = null;
    if (
      this.reinforcedDigestSprite &&
      this.reinforcedDigestSprite.complete &&
      this.reinforcedDigestSprite.naturalWidth > 0
    ) {
      this.reinforcedDigestAnimation = new SpriteAnimation(
        this.reinforcedDigestSprite,
        PLAYER_ACTUAL_FRAME_WIDTH,
        PLAYER_ACTUAL_FRAME_HEIGHT,
        PLAYER_DIGEST_NUM_FRAMES,
  ...
  shoot() {
    ...
    if (this.isMachineLanguageActive) {
      projectiles.push(
        new Projectile(this.x + this.displayWidth, projectileYBase, projectileType, bulletSkinId),
      );
...
class ExtraLifeCollectible {
  constructor(x, y) {
    ...
    this.animation = new SpriteAnimation(
      this.sprite,
      EXTRA_LIFE_FRAME_WIDTH,
      EXTRA_LIFE_FRAME_HEIGHT,
      EXTRA_LIFE_NUM_FRAMES,
      0.1,
    );
...
class RichBitsCollectible {
  constructor(x, y) {
    ...
    this.animation = new SpriteAnimation(
      this.sprite,
      RICH_BITS_FRAME_WIDTH,
      RICH_BITS_FRAME_HEIGHT,
      RICH_BITS_NUM_FRAMES,
      0.1,
    );
...
class DataPackageCollectible {
  constructor(x, y) {
    ...
    this.animation = new SpriteAnimation(
      this.sprite,
      DATA_PKG_FRAME_WIDTH,
      DATA_PKG_FRAME_HEIGHT,
      DATA_PKG_NUM_FRAMES,
      0.1,
    );
...
class DigitalFruitCollectible {
  constructor(x, y, type) {
    ...
    switch (type) {
      case 'kiwi':
        this.sprite = images['digitalKiwi'];
        break;
      case 'orange':
        this.sprite = images['digitalOrange'];
        break;
      case 'pear':
        this.sprite = images['digitalPear'];
        break; // --- INIZIO NUOVI CASI DIGITAL FRUITS ---
      case 'apple':
        this.sprite = images['digitalApple'];
        break;
      case 'banana':
        this.sprite = images['digitalBanana'];
        break;
      case 'berry':
        this.sprite = images['digitalBerry'];
        break;
      case 'blueberry':
        this.sprite = images['digitalBlueberry'];
        break;
      case 'cherry':
        this.sprite = images['digitalCherry'];
        break;
      case 'coconut':
        this.sprite = images['digitalCoconut'];
        break;
      case 'dragonfruit':
        this.sprite = images['digitalDragonfruit'];
        displayName = 'Dragon Fruit';
        break;
      case 'grapes':
        this.sprite = images['digitalGrapes'];
        break;
      case 'lemon':
        this.sprite = images['digitalLemon'];
        break;
      case 'melon':
        this.sprite = images['digitalMelon'];
        break;
      case 'papaya':
        this.sprite = images['digitalPapaya'];
        break;
      case 'peach':
        this.sprite = images['digitalPeach'];
        break;
      case 'pineapple':
        this.sprite = images['digitalPineapple'];
        break;
      case 'strawberry':
        this.sprite = images['digitalStrawberry'];
        break;
      case 'watermelon':
        this.sprite = images['digitalWatermelon'];
        break; // --- FINE NUOVI CASI DIGITAL FRUITS ---
      default:
        this.sprite = images['digitalPear'];
        displayName = 'Fruit'; // Fallback
    }
    ...
    this.animation = new SpriteAnimation(
      this.sprite,
      DIGITAL_FRUIT_FRAME_WIDTH,
      DIGITAL_FRUIT_FRAME_HEIGHT,
      DIGITAL_FRUIT_NUM_FRAMES,
      0.05,
    );
    this.textOffset = 0;
    this.textAnimationTimer = Math.random() * Math.PI * 2; // Metodo collect per gestire la raccolta dell'oggetto
    this.collect = (options = {}) => {
      // --- INIZIO AGGIORNAMENTO CONTATORI DIGITAL FRUITS ---
      switch (this.type) {
        case 'kiwi':
          gameStats.digitalKiwiCollected++;
          break;
        case 'orange':
          gameStats.digitalOrangeCollected++;
          break;
        case 'pear':
          gameStats.digitalPearCollected++;
          break;
        case 'apple':
          gameStats.digitalAppleCollected++;
          break;
        case 'banana':
          gameStats.digitalBananaCollected++;
          break;
        case 'berry':
          gameStats.digitalBerryCollected++;
          break;
        case 'blueberry':
          gameStats.digitalBlueberryCollected++;
          break;
        case 'cherry':
          gameStats.digitalCherryCollected++;
          break;
        case 'coconut':
          gameStats.digitalCoconutCollected++;
          break;
        case 'dragonfruit':
          gameStats.digitalDragonfruitCollected++;
          break;
        case 'grapes':
          gameStats.digitalGrapesCollected++;
          break;
        case 'lemon':
          gameStats.digitalLemonCollected++;
          break;
        case 'melon':
          gameStats.digitalMelonCollected++;
          break;
        case 'papaya':
          gameStats.digitalPapayaCollected++;
          break;
        case 'peach':
          gameStats.digitalPeachCollected++;
          break;
        case 'pineapple':
          gameStats.digitalPineappleCollected++;
          break;
        case 'strawberry':
          gameStats.digitalStrawberryCollected++;
          break;
        case 'watermelon':
          gameStats.digitalWatermelonCollected++;
          break;
...
class FloatingText {
  constructor(x, y, text, color = '#ebebf0', fontSize = 16, duration = 1.2) {
    // MODIFICATO: Aggiunti color, fontSize, duration con default
    this.x = x;
    this.y = y;
    this.text = text;
  ...
  isFinished() {
    // Assicurati che questo metodo sia presente per la rimozione dall'array
    return this.life <= 0;
  }
}
...
class Obstacle {
  constructor(x, y) {
    ...
    const randomSpriteKey =
      obstacleSpriteChoices[Math.floor(Math.random() * obstacleSpriteChoices.length)];
    ...
    if (this.sprite && this.sprite.complete && this.sprite.naturalWidth > 0) {
      ...
      console.warn(
        `Sprite ostacolo non caricato o rotto per la chiave '${randomSpriteKey}'. Sprite:`,
        this.sprite,
      );
...
class Projectile {
  ...
  constructor(x, y, type = 'normal', equippedBulletSkinId = null) {
    ...
    switch (this.type) {
      ...
      case 'machine_language':
        ...
        if (this.sprite && this.sprite.complete && this.sprite.naturalWidth > 0) {
          this.animation = new SpriteAnimation(
            this.sprite,
            MACHINE_LANGUAGE_PROJECTILE_ACTUAL_FRAME_WIDTH,
            MACHINE_LANGUAGE_PROJECTILE_ACTUAL_FRAME_HEIGHT,
            MACHINE_LANGUAGE_PROJECTILE_NUM_FRAMES,
            0.08,
          );
        }
        break;
      case 'rain_projectile': // Proiettile per la Rain Run
        ...
        if (
          ...
          this.sprite.complete &&
          this.sprite.naturalWidth > 0 &&
          RAIN_PROJECTILE_NUM_FRAMES > 1
        ) {
          this.animation = new SpriteAnimation(
            this.sprite,
            RAIN_PROJECTILE_ACTUAL_FRAME_WIDTH,
            RAIN_PROJECTILE_ACTUAL_FRAME_HEIGHT,
            RAIN_PROJECTILE_NUM_FRAMES,
            PLAYER_PROJECTILE_ANIMATION_SPEED,
          );
        } else {
          // Aggiungi un avviso se lo sprite non è valido
          console.warn(
            'WARN (Projectile Constructor): Rain Projectile sprite is not ready or invalid. Using fallback/no animation.',
          );
        }
        break;
    ...
    if (
      this.type === 'normal' &&
      equippedBulletSkinId &&
      SKIN_ASSET_MAP[equippedBulletSkinId]?.projectile
    ) {
      ...
      if (cosmeticSprite && cosmeticSprite.complete && cosmeticSprite.naturalWidth > 0) {
        ...
        console.warn(
          `Failed to load cosmetic bullet skin: ${equippedBulletSkinId}. Using default projectile sprite.`,
        );
      }
    }
  }
...
class BaseEnemy {
  ...
  loadAnimation(spriteNameKeyToLoad, frameW, frameH, numFramesAnim, animationKey) {
    ...
    if (
      spriteInstance &&
      spriteInstance.complete &&
      spriteInstance.naturalWidth > 0 &&
      numFramesAnim > 0
    ) {
      this.animations[animationKey] = new SpriteAnimation(
        spriteInstance,
        frameW,
        frameH,
        numFramesAnim,
  ...
  draw() {
    ...
    if (this.maxHealth > 1) {
      // Disegna la barra solo se ha più di 1 HP max
      ...
      ctx.fillStyle =
        this.health > this.maxHealth * 0.3 ? 'rgba(0,255,0,0.7)' : 'rgba(255,0,0,0.7)'; // Verde o Rosso (sotto 30%)
      ...
      ctx.fillText(
        ...
        healthBarY + healthBarHeight / 2 + 3,
      ); // Centra il testo
...
class EnemyProjectile {
  constructor(
    ...
    if (this.sprite && this.sprite.complete && this.sprite.naturalWidth > 0 && numFrames > 1) {
      ...
      // Gestisce sprite a singolo frame
...
class KamikazeFlyingEnemy extends BaseEnemy {
  constructor(x, y, targetPlayerX, targetPlayerY) {
    ...
    console.log(
      `[FEAT] KamikazeFlyingEnemy istanziato a X:${x}, Y:${y} mirando a playerX:${targetPlayerX}, playerY:${targetPlayerY}`,
    );
  }
...
class Glitchzilla extends BaseEnemy {
  ...
  update(dt) {
    ...
    if (this.health <= GLITCHZILLA_HEALTH * 0.5 && this.specialAttackReady && Math.random() < 0.3) {
      // 30% di probabilità
    ...
    if (phaseComplete) {
      ...
      // >>> START OF MODIFICATION
      if (!this.isWarning) {
        // Only if we are not entering a new warning state
        this.updateCurrentAnimation();
      }
      // <<< END OF MODIFICATION
    }
...
class TrojanByte extends BaseEnemy {
  constructor(x, y) {
    ...
    super(
      ...
      initialHealth,
      '#FF00FF',
      TROJAN_BYTE_SCORE_VALUE, // UTILIZZA initialHealth CALCOLATA
    );
  ...
  generateNewAttackPattern() {
    ...
    switch (chosenAttackType) {
      ...
      case 'vertical_sweep_down':
        this.attackPattern.push({ type: 'warn' });
        this.attackPattern.push({ type: 'shot', position: 'high' });
        this.attackPattern.push({ type: 'pause', duration: this.pauseBetweenShots });
        this.attackPattern.push({ type: 'warn' });
        this.attackPattern.push({ type: 'shot', position: 'middle' });
        this.attackPattern.push({ type: 'pause', duration: this.pauseBetweenShots });
        this.attackPattern.push({ type: 'warn' });
        this.attackPattern.push({ type: 'shot', position: 'low' });
        this.attackPattern.push({ type: 'pause', duration: this.pauseBetweenShots });
        break;
    ...
    if (
      chosenAttackType !== 'delayed_burst_sequence' &&
      chosenAttackType !== 'charged_burst_attack'
    ) {
      // Aggiornato
      this.attackPattern.push({ type: 'pause', duration: this.pauseLongDuration });
    }
    ...
    if (this.state === 'ENTERING') {
      ...
      switch (currentAction.type) {
        ...
        case 'warn_charge':
          ...
          if (this.actionTimer >= this.chargeWarningDuration) {
            // Use specific charge duration
            this.isWarning = false;
        ...
        case 'shot':
          ...
          enemyProjectiles.push(
            new EnemyProjectile(
              this.x,
              projectileY,
              'trojanByteProjectile',
              TROJAN_BYTE_PROJECTILE_ACTUAL_FRAME_WIDTH,
              TROJAN_BYTE_PROJECTILE_ACTUAL_FRAME_HEIGHT,
              TROJAN_BYTE_PROJECTILE_NUM_FRAMES,
              TROJAN_BYTE_PROJECTILE_TARGET_WIDTH,
              TROJAN_BYTE_PROJECTILE_TARGET_HEIGHT,
        ...
        case 'shoot_charged_projectile': // NUOVO: Caso per il proiettile caricato
          if (!this.shotFiredInPhase) {
            // Assicurati che spari solo una volta per azione
  ...
  update(dt) {
    ...
    switch (currentAction.type) {
      ...
      case 'warn_entity_spawn':
        ...
        if (this.currentAttackPhaseDuration >= WARNING_DURATION * 1.5) {
          // 0.6s di avviso
          actionComplete = true;
          this.isWarning = false;
          this.soundPlayedInPhase = false;
      ...
      case 'spawn_entities':
        if (!this.shotFiredInPhase && currentAction.count > 0) {
          ...
          for (let i = 0; i < spawnCount; i++) {
            ...
            enemies.push(
              // Aggiungili all'array principale dei nemici
...
class DunnoExeProjectile1 extends EnemyProjectile {
  constructor(x, y, targetPlayerY, isLandedShot = false) {
    super(
      ...
      y,
      'dunnoExeProjectile1',
      DUNNO_EXE_PROJECTILE_1_FRAME_WIDTH,
      DUNNO_EXE_PROJECTILE_1_FRAME_HEIGHT,
      DUNNO_EXE_PROJECTILE_1_NUM_FRAMES,
      DUNNO_EXE_PROJECTILE_1_TARGET_WIDTH,
      DUNNO_EXE_PROJECTILE_1_TARGET_HEIGHT,
    ...
    console.log(
      `DUNNO.EXE: PROJ1 istanziato a X:${x}, Y:${y}, targetY:${targetPlayerY} (Landed: ${isLandedShot})`,
    );
  }
...
class DunnoExeProjectile2 extends EnemyProjectile {
  constructor(x, y) {
    super(
      ...
      y,
      'dunnoExeProjectile2',
      DUNNO_EXE_PROJECTILE_2_FRAME_WIDTH,
      DUNNO_EXE_PROJECTILE_2_FRAME_HEIGHT,
      DUNNO_EXE_PROJECTILE_2_NUM_FRAMES,
      DUNNO_EXE_PROJECTILE_2_TARGET_WIDTH,
      DUNNO_EXE_PROJECTILE_2_TARGET_HEIGHT,
    ...
    console.log(
      `DUNNO.EXE: PROJ2 (Oscillating) istanziato a X:${x}, Y:${y}, Speed: ${this.speed}, Freq: ${this.frequency}`,
    );
  }
...
class DunnoExeProjectile3 extends EnemyProjectile {
  constructor(x, y, targetPlayerY) {
    super(
      ...
      y,
      'dunnoExeProjectile3',
      DUNNO_EXE_PROJECTILE_3_FRAME_WIDTH,
      DUNNO_EXE_PROJECTILE_3_FRAME_HEIGHT,
      DUNNO_EXE_PROJECTILE_3_NUM_FRAMES,
      DUNNO_EXE_PROJECTILE_3_TARGET_WIDTH,
      DUNNO_EXE_PROJECTILE_3_TARGET_HEIGHT,
    ...
    switch (this.phase) {
      ...
      case 'DISAPPEARING':
        if (this.timer >= this.disappearDuration) {
          ...
          this.y =
            asyncDonkey.y + Math.random() * this.reappearOffsetRange * 2 - this.reappearOffsetRange;
...
class DunnoExe extends BaseEnemy {
  constructor(x, y) {
    ...
    super(
      x,
      y,
      DUNNO_EXE_TARGET_WIDTH,
      DUNNO_EXE_TARGET_HEIGHT,
      'dunnoExeFlying', // Sprite iniziale di volo
      DUNNO_EXE_ACTUAL_FRAME_WIDTH,
      DUNNO_EXE_ACTUAL_FRAME_HEIGHT,
      DUNNO_EXE_NUM_FRAMES,
      0.2,
      initialHealth,
      '#5D3FD3', // Colore fallback viola // UTILIZZA initialHealth CALCOLATA
  ...
  generateNewAttackPattern() {
    ...
    if (this.state === 'FLYING') {
      ...
      if (this.health <= DUNNO_EXE_HEALTH * 0.75) {
        // Damaged flying pattern (was 0.5)
      ...
      // Only generate for LANDED_SHIELD_ON
    ...
    console.log(
      `DUNNO.EXE generato nuovo pattern di attacco per stato ${this.state}. Pattern:`,
      this.currentAttackPattern.map((a) => a.type + (a.action ? `:${a.action}` : '')),
    );
  }
  ...
  handleAttackPattern(dt) {
    ...
    if (
      !this.currentAttackPattern ||
      this.currentAttackPattern.length === 0 ||
      this.currentAttackIndex >= this.currentAttackPattern.length
    ) {
      this.generateNewAttackPattern();
      return;
    }
    ...
    const actionDuration =
      typeof currentAction.duration !== 'undefined' ? currentAction.duration : 0;
    // <<< END OF MODIFICATION
      ...
      case 'shoot':
        if (!this.shotFiredInPhase) {
          ...
          switch (currentAction.action) {
            case 'shoot_proj1':
              enemyProjectiles.push(
                new DunnoExeProjectile1(
                  this.x,
                  projectileY + (currentAction.offsetY || 0),
                  targetY + (currentAction.offsetY || 0),
                  currentAction.isLandedShot,
                ),
              );
              AudioManager.playSound(
                'enemyShootLight',
                false,
                currentAction.isLandedShot ? 1.0 : 0.8,
                currentAction.isLandedShot ? 1.2 : 1.0,
              );
              break;
        ...
        if (this.actionTimer >= actionDuration) {
          // Use actionDuration for completion
          actionComplete = true;
        }
        // <<< END OF MODIFICATION
        break;
...
function spawnFlyingEnemyIfNeeded(dt) {
  ...
  if (flyingEnemySpawnTimer >= nextFlyingEnemySpawnTime) {
    const enemyY =
      50 + Math.random() * (canvas.height - groundHeight - ENEMY_FIVE_TARGET_HEIGHT - 100);
...
function spawnDangerousFlyingEnemyIfNeeded(dt) {
  ...
  if (dangerousFlyingEnemySpawnTimer >= nextDangerousFlyingEnemySpawnTime) {
    const enemyY =
      30 +
      Math.random() * (canvas.height - groundHeight - DANGEROUS_FLYING_ENEMY_TARGET_HEIGHT - 150);
...
function spawnKamikazeFlyingEnemyIfNeeded(dt) {
  ...
  if (
    ...
    if (kamikazeFlyingEnemySpawnTimer >= nextKamikazeFlyingEnemySpawnTime) {
      ...
      const spawnY =
        50 +
        Math.random() * (canvas.height - groundHeight - KAMIKAZE_FLYING_ENEMY_TARGET_HEIGHT - 100);

      // Mira alla posizione attuale del giocatore al momento dello spawn
      kamikazeFlyingEnemies.push(
        new KamikazeFlyingEnemy(
          canvas.width,
          spawnY,
          asyncDonkey.x + asyncDonkey.displayWidth / 2,
...
// Se il Purge Protocol è attivo, non spawnare nessun power-up ambientale.
  ...
  if (powerUpSpawnTimer >= nextPowerUpSpawnTime) {
    ...
    else if (isGlitchzillaDefeatedThisGame && Math.random() < 0.2) {
      // 20% di probabilità
    ...
    // 4. Altrimenti, spawn di power-up casuali esistenti
      ...
      const availablePowerUpTypes = Object.values(POWERUP_TYPE).filter(
        (type) => !nonAmbientPowerUps.includes(type),
      );

      if (availablePowerUpTypes.length > 0) {
        powerupToSpawn =
          availablePowerUpTypes[Math.floor(Math.random() * availablePowerUpTypes.length)];
      }
    }
...
async function processGameOver() {
  ...
  if (!window.currentUserData || window.currentUserData.userId !== localUserId) {
    console.error(
      "window.currentUserData non disponibile o non corrisponde all'utente locale. Impossibile salvare le statistiche.",
    ); //
  ...
  currentUserData.gameStats.totalGamesPlayed =
    (currentUserData.gameStats.totalGamesPlayed || 0) + 1; //
  ...
  if (finalScore > (currentUserData.gameStats.highestScore || 0)) {
    ...
    finalScore === currentUserData.gameStats.highestScore &&
    isRainRunActive &&
    !(currentUserData.gameStats.isHighestScoreRainy || false)
  ) {
    currentUserData.gameStats.isHighestScoreRainy = true; //
  }

  currentUserData.gameStats.bossesDefeated =
    (currentUserData.gameStats.bossesDefeated || 0) + bossesDefeatedCount; //
  currentUserData.gameStats.totalBits = (currentUserData.gameStats.totalBits || 0) + bits; // <-- CORRETTO
  currentUserData.gameStats.totalDigitalFruits =
    (currentUserData.gameStats.totalDigitalFruits || 0) + gameStats.digitalFruitsCollected;
  ...
  if (
    gameStats.dataPacketsCollected > (currentUserData.gameStats.highestDataPacketsCollectedRun || 0)
  ) {
    //
  ...
  if (
    gameStats.digitalFruitsCollected >
    (currentUserData.gameStats.highestDigitalFruitsCollected || 0)
  ) {
    //
  ...
  currentUserData.gameStats.totalDigitalKiwiCollected =
    (currentUserData.gameStats.totalDigitalKiwiCollected || 0) + gameStats.digitalKiwiCollected; //
  currentUserData.gameStats.totalDigitalOrangeCollected =
    (currentUserData.gameStats.totalDigitalOrangeCollected || 0) + gameStats.digitalOrangeCollected; //
  currentUserData.gameStats.totalDigitalPearCollected =
    (currentUserData.gameStats.totalDigitalPearCollected || 0) + gameStats.digitalPearCollected; //
  currentUserData.gameStats.totalDigitalAppleCollected =
    (currentUserData.gameStats.totalDigitalAppleCollected || 0) + gameStats.digitalAppleCollected; //
  currentUserData.gameStats.totalBananaCollected =
    (currentUserData.gameStats.totalBananaCollected || 0) + gameStats.digitalBananaCollected; //
  currentUserData.gameStats.totalBerryCollected =
    (currentUserData.gameStats.totalBerryCollected || 0) + gameStats.digitalBerryCollected; //
  currentUserData.gameStats.totalBlueberryCollected =
    (currentUserData.gameStats.totalBlueberryCollected || 0) + gameStats.digitalBlueberryCollected; //
  currentUserData.gameStats.totalCherryCollected =
    (currentUserData.gameStats.totalCherryCollected || 0) + gameStats.digitalCherryCollected; //
  currentUserData.gameStats.totalCoconutCollected =
    (currentUserData.gameStats.totalCoconutCollected || 0) + gameStats.digitalCoconutCollected; //
  currentUserData.gameStats.totalDragonfruitCollected =
    (currentUserData.gameStats.totalDragonfruitCollected || 0) +
    gameStats.digitalDragonfruitCollected; //
  currentUserData.gameStats.totalGrapesCollected =
    (currentUserData.gameStats.totalGrapesCollected || 0) + gameStats.digitalGrapesCollected; //
  currentUserData.gameStats.totalLemonCollected =
    (currentUserData.gameStats.totalLemonCollected || 0) + gameStats.digitalLemonCollected; //
  currentUserData.gameStats.totalMelonCollected =
    (currentUserData.gameStats.totalMelonCollected || 0) + gameStats.digitalMelonCollected; //
  currentUserData.gameStats.totalPapayaCollected =
    (currentUserData.gameStats.totalPapayaCollected || 0) + gameStats.digitalPapayaCollected; //
  currentUserData.gameStats.totalPeachCollected =
    (currentUserData.gameStats.totalPeachCollected || 0) + gameStats.digitalPeachCollected; //
  currentUserData.gameStats.totalPineappleCollected =
    (currentUserData.gameStats.totalPineappleCollected || 0) + gameStats.digitalPineappleCollected; //
  currentUserData.gameStats.totalStrawberryCollected =
    (currentUserData.gameStats.totalStrawberryCollected || 0) +
    gameStats.digitalStrawberryCollected; //
  currentUserData.gameStats.totalWatermelonCollected =
    (currentUserData.gameStats.totalWatermelonCollected || 0) +
    gameStats.digitalWatermelonCollected; //
  ...
  if (isRainRunActive) {
    ...
    if (
      ...
      (currentUserData.gameStats.highestRainRunEnemiesDefeated || 0)
    ) {
      //
  ...
  for (const categoryKey in FRONTEND_BADGE_TIERS) {
    ...
    if (category.type === 'individual_boss') {
      ...
      // Nuovo: Badge cumulativo multi-frutta
        ...
        for (const fruitType in category.thresholds) {
          ...
          const current =
            userProfile.gameStats?.[
              `total${fruitType.charAt(0).toUpperCase() + fruitType.slice(1)}Collected`
            ] || 0;
          if (current < required) {
      ...
      // Badge a livelli basati su metriche
      ...
      switch (category.metric) {
        ...
        default:
          console.warn(
            `[processGameOver] Metric '${category.metric}' not explicitly mapped for badge calculation. Using 0.`,
          );
      ...
      if (newMaxLevel > currentMaxLevel) {
        ...
        if (!earnedBadges.has(newBadgeId)) {
          ...
          if (
            unlockedTier?.unlocksSkin &&
            !updatedUnlockedItemsForBadges.has(unlockedTier.unlocksSkin)
          ) {
  ...
  try {
    ...
    console.log(
      '[donkeyRunner.js] Statistiche di gioco e badge/skin salvati localmente:',
      currentUserData.gameStats,
    );
    ...
    console.error(
      '[donkeyRunner.js] Errore nel salvataggio delle statistiche, badge e skin su IndexedDB:',
      error,
    ); //
...
function removeEnemyFromAnyArray(enemyToRemove) {
  ...
  for (const enemyArray of allEnemyArrays) {
    ...
    if (index > -1) {
      enemyArray.splice(index, 1); //console.log(`DEBUG_REMOVAL: Rimosso nemico dal suo array originale. Tipo: ${enemyToRemove.constructor.name}`);
...
function checkCollisions() {
  ...
  for (let i = projectiles.length - 1; i >= 0; i--) {
    ...
    if (!proj) continue;
    const allShootableEnemyTargets = [
      ...enemies,
      ...fastEnemies,
      ...armoredEnemies,
      ...shootingEnemies,
    ...
    for (let j = allShootableEnemyTargets.length - 1; j >= 0; j--) {
      ...
      if (
        ...
        AudioManager.playSound('enemyHit');
        projectiles.splice(i, 1);
        projectileRemoved = true; // NUOVO: Logica di rimozione del nemico dopo che è stato sconfitto da un proiettile
  ...
  const allCompanionProjectiles = companionManager
    ? companionManager.getAllCompanionProjectiles()
    : [];
  for (let i = allCompanionProjectiles.length - 1; i >= 0; i--) {
    ...
    if (!cProj.sprite || typeof cProj.sprite.src === 'undefined') {
      console.warn(
        `DEBUG_COLLISIONI: Proiettile compagno (${cProj.type}) senza oggetto sprite valido o senza proprietà src. Saltando collisione.`,
      );
      continue;
    }
    ...
    for (let j = companionTargets.length - 1; j >= 0; j--) {
      ...
      if (
        ...
        companionProjectileRemoved = true; // NUOVO: Logica di rimozione del nemico dopo che è stato sconfitto da un proiettile compagno
        if (enemy.health <= 0) {
          if (enemy !== activeMiniboss) {
            if (removeEnemyFromAnyArray(enemy)) {
              score += enemy.scoreValue;
    ...
    if (
      ...
      if (eProj.isHarmful) {
        ...
        if (!eProj.isHarmful && Math.random() < 0.4) {
          const randomMsg =
            TASTY_BUG_MESSAGES[Math.floor(Math.random() * TASTY_BUG_MESSAGES.length)];
          floatingTexts.push(
            new FloatingText(
              asyncDonkey.x + asyncDonkey.displayWidth / 2,
              asyncDonkey.y,
...
function initializeBackgroundParticles() {
  backgroundParticles = [];
  const chars = '01ABCDEFGHIJKLMNOPQRSTUVWXYZ<>!@#$%^&*()_+{}|[]?'; // Creiamo 3 livelli di particelle per l'effetto parallasse
  const layers = [
...
function resetGame(options = {}) {
  ...
  console.log(
    'NUOVO LOG DI DEBUG: asyncDonkey istanza creata/riassegnata in resetGame:',
    asyncDonkey,
  );
  ...
  if (isRainRunActive) {
    // SOSTITUISCI 'isRainingInGame' con 'isRainRunActive' qui
...
function drawTerminalBackgroundEffects() {
  ...
  const currentTheme =
    activeMiniboss && activeMiniboss.name ? BOSS_THEMES[activeMiniboss.name] : null; // 1. Disegna le particelle del background dinamico

  ctx.save();
  backgroundParticles.forEach((p) => {
    let particleColor; // Se c'è un tema boss e una piccola probabilità, usa un colore "glitch"
    if (currentTheme && Math.random() < 0.15) {
      // 15% di probabilità di glitch
  ...
  ctx.restore(); // 2. Disegna l'effetto Scanlines sopra a tutto
...
function updatePlaying(dt) {
  ...
  if (!activeMiniboss && !bossFightImminent && !postBossCooldownActive) {
    if (!isGlitchzillaDefeatedThisGame && score >= GLITCHZILLA_SPAWN_SCORE_THRESHOLD) {
      console.log(
        'Soglia punteggio per Glitchzilla raggiunta. Avvio sequenza di spawn (2s warning).',
      );
      willSpawnBoss = true;
      ...
      console.log(
        'Soglia punteggio per Trojan_Byte raggiunta. Avvio sequenza di spawn (2s warning).',
      );
      willSpawnBoss = true;
      bossFightImminent = true;
      bossWarningTimer = 2.0;
      ...
      console.log(
        'Soglia punteggio per Missing_Number raggiunta. Avvio sequenza di spawn (2s warning).',
      );
      willSpawnBoss = true;
      bossFightImminent = true;
      bossWarningTimer = 2.0;
      ...
      // NUOVO: Logica di spawn per DUNNO.EXE
      isGlitchzillaDefeatedThisGame &&
      isTrojanByteDefeatedThisGame &&
      isMissingNumberDefeatedThisGame &&
      ...
      console.log(
        'Soglia punteggio per DUNNO.EXE raggiunta. Avvio sequenza di spawn (2s warning).',
      );
      willSpawnBoss = true;
      bossFightImminent = true;
      bossWarningTimer = 2.0;
    ...
    if (willSpawnBoss) {
      ...
      } else if (hasDunnoExeSpawnedThisGame && !isDunnoExeDefeatedThisGame) {
        // NUOVO
  ...
  if (bossFightImminent && !activeMiniboss && !postBossCooldownActive) {
    ...
    if (bossWarningTimer <= 0) {
      ...
      if (hasGlitchzillaSpawnedThisGame && !isGlitchzillaDefeatedThisGame) {
        ...
        activeMiniboss = new DunnoExe(
          canvas.width,
          canvas.height / 2 - DUNNO_EXE_TARGET_HEIGHT / 2,
        ); // Posizione iniziale a metà schermo in altezza
        bossJustSpawned = true;
      }
  ...
  for (let i = kamikazeFlyingEnemies.length - 1; i >= 0; i--) {
    ...
    if (
      kamikazeFlyingEnemies[i].x + kamikazeFlyingEnemies[i].width < 0 ||
      kamikazeFlyingEnemies[i].y > canvas.height ||
      kamikazeFlyingEnemies[i].y + kamikazeFlyingEnemies[i].height < 0
    ) {
  ...
  if (isRainRunActive) {
    ...
    if (thunderclapGameTimer >= nextThunderclapGameInterval) {
      console.log(
        'DEBUG (updatePlaying): Tentativo di riprodurre il tuono. isRainRunActive:',
        isRainRunActive,
      ); // Modifica qui
  ...
  if (currentGameState === GAME_STATE.PLAYING) {
    ...
    MissionManager.updateMissionProgress('game_tick', {
      dt: dt,
...
function drawGameOverScreen() {
  ...
  drawGlitchText(
    ...
    6,
    3,
  ); // <-- DECOMMENTA/RIPRISTINA QUESTA RIGA
  drawGlitchText(
...
function gameLoop(timestamp) {
  ...
  if (isNaN(deltaTime)) {
    console.warn('CRITICAL: deltaTime is NaN!', {
      timestamp: timestamp,
      lastTime: lastTime,
      calculatedDt: deltaTime,
    });
  }
  // --- FINE LOG DI DEBUG ---
...
async function attachEventListeners() {
  ...
  if (mainMenuBtn) {
    mainMenuBtn.addEventListener('click', () => {
      // Corretto da 'mainMenu' a 'mainMenuBtn'
    ...
    switch (currentGameState) {
      ...
      case 'PAUSE': // NUOVO: Gestione input in pausa
        if (e.key === 'Escape' || e.key === 'p' || e.key === 'P') {
          // Torna al gioco con Esc o P
          resumeGame();
        }
        if (e.key === 'r' || e.key === 'R') {
          // Riavvia dalla pausa con R
          if (pauseModal) pauseModal.style.display = 'none';
          if (pauseButton) pauseButton.style.display = 'block';
          launchGame();
        }
        if (e.key === 'm' || e.key === 'M') {
          // Torna al menu principale dalla pausa con M
          if (pauseModal) pauseModal.style.display = 'none';
          if (pauseButton) pauseButton.style.display = 'block';
          if (window.returnToMainMenu) {
            window.returnToMainMenu();
