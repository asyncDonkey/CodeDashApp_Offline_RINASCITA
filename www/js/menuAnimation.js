...
import { COMPANION_ASSET_MAP, GLOBAL_SPRITE_SCALE_FACTOR, SKIN_ASSET_MAP } from './donkeyRunner.js';
...
const RAIN_PENDING_PHRASES = [
  'AWAITING RAIN...',
  'SCANNING FOR RAIN...',
  'IMMINENT DIGITAL RAIN...',
];

export const bitTypes = {
  bronze: {
    value: 1,
    src: 'images/bits/bit_bronze.png',
    width: 16,
    height: 16,
    frameCount: 8,
    ticksPerFrame: 25,
  ...
  silver: {
    value: 2,
    src: 'images/bits/bit_silver.png',
    width: 16,
    height: 16,
    frameCount: 8,
    ticksPerFrame: 25,
  ...
  platinum: {
    value: 10,
    src: 'images/bits/bit_platinum.png',
    width: 16,
    height: 16,
    frameCount: 8,
    ticksPerFrame: 25,
  ...
  crystal: {
    value: 250,
    src: 'images/bits/bit_crystal.png',
    width: 16,
    height: 16,
    frameCount: 8,
    ticksPerFrame: 25,
  ...
  digital_kiwi: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_kiwi.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_orange: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_orange.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_pear: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_pear.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_apple: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_apple.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_banana: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_banana.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_berry: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_berry.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_blueberry: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_blueberry.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
    name: 'digital_blueberry',
  },
  digital_cherry: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_cherry.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_coconut: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_coconut.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
    name: 'digital_coconut',
  },
  digital_dragonfruit: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_dragonfruit.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
    name: 'digital_dragonfruit',
  },
  digital_grapes: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_grapes.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_lemon: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_lemon.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_melon: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_melon.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_papaya: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_papaya.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_peach: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_peach.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
  ...
  digital_pineapple: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_pineapple.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
    name: 'digital_pineapple',
  },
  digital_strawberry: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_strawberry.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
    name: 'digital_strawberry',
  },
  digital_watermelon: {
    value: 0,
    fruitEquivalent: 1,
    src: 'images/bits/digital_fruits/digital_watermelon.png',
    width: 16,
    height: 16,
    frameCount: 1,
    ticksPerFrame: 30,
    name: 'digital_watermelon',
  },
...
class MenuDonkey {
  constructor(canvas, sprite, digestSprite, initialX = 50) {
    ...
    this.speechMessages = [
      ...
      '<3__<3',
      '-rm -rf',
      "That's some good async.",
    ];
    this.digestMessages = ['Digesting data...', 'Parsing complete.', 'Mmm, bytes!', 'CRUNCH.'];
    ...
    if (this.isSpeaking) {
      ...
      if (this.typewriterIndex < this.currentSpeechText.length) {
        ...
        if (this.typewriterTick >= this.typewriterSpeed) {
          ...
          this.speechBubble.innerHTML =
            this.currentSpeechText.substring(0, this.typewriterIndex) +
...
export const menuAnimation = {
  ...
  preloadCompanionSprites(unlockedCompanionIds) {
    const promises = unlockedCompanionIds.map((id) => {
      ...
      if (!companionConfig || !companionConfig.sprite) {
        console.warn(
          `[MenuAnimation] Configurazione o percorso sprite mancante per il compagno: ${id}`,
        );
      ...
      return new Promise((resolve) => {
        ...
        img.onerror = () => {
          console.error(
            `[MenuAnimation] Impossibile caricare lo sprite del compagno: ${companionConfig.sprite}`,
          );
  ...
  init(canvasId) {
    // Rimosso initialDonkeyPos e unlockedCompanionIds da qui
    ...
    this.canvas.addEventListener(
      ...
      { passive: false },
    ); // Usare passive: false per permettere preventDefault
    ...
    try {
      ...
      console.error(
        "[MenuAnimation] Errore nel caricamento di 'menuCollectedItemCounts' dal localStorage:",
        e,
      );
    ...
    console.log(
      `[MenuAnimation] Caricati ${JSON.stringify(this.collectedItemCounts)} item dal localStorage.`,
    );
    ...
    Promise.all([
      ...
      .catch((error) => {
        console.error(
          "[MenuAnimation] Errore nel caricamento degli asset audio, l'animazione potrebbe avere problemi:",
          error,
        );
  ...
  updateMenuPlayerDisplay(userData) {
    if (!this.donkey || !this.canvas || !this.ctx) {
      console.warn(
        "Menu animation non completamente inizializzata per l'aggiornamento del display del giocatore.",
      );
      return;
    }

    // 1. Aggiorna gli sprite del MenuDonkey basandosi sulla skin equipaggiata
    const equippedDonkeySkinId =
      userData.inventory?.equipped?.donkeySkin || 'skin_donkey_default_info';
    ...
    Promise.all([
      ...
      .catch((e) =>
        console.error("Errore durante l'aggiornamento degli sprite del Donkey nel menu:", e),
      );
    ...
    if (equippedCompanionId && equippedCompanionId !== 'null_companion') {
      ...
      if (companionConfig && companionConfig.sprite) {
        loadImageForMenuDisplay(companionConfig.sprite)
          .then((companionImg) => {
            if (companionImg) {
              ...
              console.log(
                `[MenuAnimation] Aggiornato compagno equipaggiato nel menu: ${equippedCompanionId}`,
              );
            }
          })
          .catch((e) =>
            console.error('Errore caricamento sprite compagno per aggiornamento menu:', e),
          );
      }
    }
  ...
  generateRandomSpawnInterval() {
    return (
      MIN_BIT_SPAWN_INTERVAL + Math.random() * (MAX_BIT_SPAWN_INTERVAL - MIN_BIT_SPAWN_INTERVAL)
    );
  },
  ...
  handleCanvasClick(event) {
    ...
    if (
      ...
      console.warn(
        '[MenuAnimation] clientX or clientY is undefined/null from event. Skipping click processing.',
      );
      return;
    }
    ...
    for (let i = this.bits.length - 1; i >= 0; i--) {
      ...
      if (
        clickX >= bit.x &&
        clickX <= bit.x + bit.width &&
        clickY >= bit.y &&
        clickY <= bit.y + bit.height
      ) {
        console.log(
          `[MenuAnimation] Click detected on bit ${i}! Donkey state: ${this.donkey.state}`,
        );
        if (
          this.donkey.state !== 'targeting' &&
          this.donkey.state !== 'digesting' &&
          this.donkey.state !== 'processing'
        ) {
          ...
          console.log(
            `[MenuAnimation] Donkey is busy (${this.donkey.state}), cannot target new bit.`,
          );
        }
      }
    }
    for (let i = this.companions.length - 1; i >= 0; i--) {
      ...
      if (
        clickX >= companion.x &&
        clickX <= companion.x + companion.dw &&
        clickY >= companion.y &&
        clickY <= companion.y + companion.dh
      ) {
        companion.say();
        break;
      }
  ...
  resizeCanvas() {
    ...
    if (this.donkey)
      this.donkey.groundY = this.canvas.height * GROUND_LEVEL_PERCENT - this.donkey.dh;
  },
  ...
  loop() {
    ...
    const timeUntilNextRainChance =
      this.digitalRainChanceInterval - (currentTime - this.lastDigitalRainChanceTime);
    const HINT_THRESHOLD = 5000;

    if (
      !this.isDigitalRainActive &&
      timeUntilNextRainChance <= HINT_THRESHOLD &&
      timeUntilNextRainChance > 0 &&
      !this.isDonkeyHintingRain
    ) {
    ...
    if (
      !this.isDigitalRainActive &&
      currentTime - this.lastDigitalRainChanceTime >= this.digitalRainChanceInterval
    ) {
      if (Math.random() < 0.5) {
    ...
    if (this.isDigitalRainActive) {
      ...
      if (this.digitalRainTimer <= 0) {
        ...
        window.dispatchEvent(
          new CustomEvent('rainStatusChanged', { detail: { isRaining: false } }),
        );
      }
    ...
    if (this.donkey.target) {
      const donkeyRect = {
        x: this.donkey.x,
        y: this.donkey.y,
        width: this.donkey.dw,
        height: this.donkey.dh,
      };
      const targetBit = this.donkey.target;
      const bitRect = {
        x: targetBit.x,
        y: targetBit.y,
        width: targetBit.width,
        height: targetBit.height,
      };

      if (
        donkeyRect.x < bitRect.x + bitRect.width &&
        donkeyRect.x + donkeyRect.width > bitRect.x &&
        donkeyRect.y < bitRect.y + bitRect.height &&
        donkeyRect.y + bitRect.height > bitRect.y
      ) {
        for (let i = 0; i < 20; i++) {
          this.particles.push(
            new Particle(
              targetBit.x + targetBit.width / 2,
              targetBit.y + targetBit.height / 2,
              '#ffb86c',
            ),
          );
        }
        ...
        if (this.isUserAuthenticated) {
          this.collectedItemCounts[targetBit.type.name] =
            (this.collectedItemCounts[targetBit.type.name] || 0) + 1;
          localStorage.setItem('menuCollectedItemCounts', JSON.stringify(this.collectedItemCounts));
          console.log(
            `Raccolto 1 ${targetBit.type.name}. Conteggi attuali: ${JSON.stringify(this.collectedItemCounts)}`,
          );
    ...
    if (
      this.bits.length < MAX_BITS_ON_SCREEN &&
      currentTime - this.lastBitSpawnTime >= this.nextBitSpawnInterval
    ) {
      this.spawnBit();
      this.lastBitSpawnTime = currentTime;
      this.nextBitSpawnInterval = this.generateRandomSpawnInterval();
