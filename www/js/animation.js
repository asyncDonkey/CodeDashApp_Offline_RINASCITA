...
export class SpriteAnimation {
  constructor(spritesheet, frameWidth, frameHeight, numFrames, animationSpeed = 0.1) {
    ...
    if (numFrames <= 0) {
      console.warn(
        'Animazione creata con 0 o meno frame!',
        spritesheet ? spritesheet.src : 'Spritesheet nullo',
      );
      ...
      if (spritesheet.naturalWidth === 0 || spritesheet.naturalHeight === 0) {
        ...
        spritesheet.naturalWidth % frameWidth !== 0 ||
        spritesheet.naturalHeight % frameHeight !== 0
      ) {
