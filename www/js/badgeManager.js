...
export const FRONTEND_BADGE_TIERS = {
    ...
    tiers: [
      {
        ...
        id: 'score_rookie',
        name: 'Score Initiate',
        description: 'Reach 500 points in a single run.',
        icon: 'images/badges/score_master_1.png',
      },
      {
        level: 2,
        threshold: 2500,
        ...
        description: 'Reach 2500 points in a single run.',
        icon: 'images/badges/score_master_2.png',
      },
      {
        level: 3,
        threshold: 5000,
        id: 'score_elite',
        name: 'Score Artisan',
        description: 'Reach 5000 points in a single run.',
        icon: 'images/badges/score_master_3.png',
      },
      {
        level: 4,
        threshold: 10000,
        ...
        description: 'Reach 10000 points in a single run.',
        icon: 'images/badges/score_master_4.png',
      },
      {
        level: 5,
        threshold: 25000,
        id: 'score_legend',
        name: 'Score Legend',
        description: 'Reach 25000 points in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_score_legend',
        icon: 'images/badges/score_master_5.png',
      },
    ],
  },
  BUG_HUNTER: {
    ...
    tiers: [
      {
        level: 1,
        threshold: 10,
        id: 'bug_hunter_rookie',
        name: 'Bug Scout',
        description: 'Debug 10 enemies in a single run.',
        icon: 'images/badges/bug_hunter_1.png',
      },
      {
        level: 2,
        threshold: 50,
        id: 'bug_hunter_veteran',
        name: 'Bug Fixer',
        description: 'Debug 50 enemies in a single run.',
        icon: 'images/badges/bug_hunter_2.png',
      },
      {
        level: 3,
        threshold: 100,
        id: 'bug_hunter_expert',
        name: 'Bug Exterminator',
        description: 'Debug 100 enemies in a single run.',
        icon: 'images/badges/bug_hunter_3.png',
      },
      {
        level: 4,
        threshold: 200,
        id: 'bug_hunter_master',
        name: 'Bug Hunter Elite',
        description: 'Debug 200 enemies in a single run.',
        icon: 'images/badges/bug_hunter_4.png',
      },
      {
        level: 5,
        threshold: 350,
        id: 'bug_hunter_elite',
        name: 'Bug Whisperer',
        description: 'Debug 350 enemies in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_bug_whisperer',
        icon: 'images/badges/bug_hunter_5.png',
      },
    ],
  },
  JUMPER: {
    ...
    tiers: [
      {
        ...
        id: 'jumper_rookie',
        name: 'Jumper Novice',
        description: 'Jump 500 times in a single run.',
        icon: 'images/badges/jumper_1.png',
      },
      {
        level: 2,
        threshold: 250,
        id: 'jumper_veteran',
        name: 'Jumper Adept',
        description: 'Jump 2500 times in a single run.',
        icon: 'images/badges/jumper_2.png',
      },
      {
        level: 3,
        threshold: 500,
        id: 'jumper_elite',
        name: 'Jumper Master',
        description: 'Jump 5000 times in a single run.',
        icon: 'images/badges/jumper_3.png',
      },
      {
        level: 4,
        threshold: 1000,
        id: 'jumper_master',
        name: 'Jumper Grand',
        description: 'Jump 10000 times in a single run.',
        icon: 'images/badges/jumper_4.png',
      },
      {
        level: 5,
        threshold: 2500,
        id: 'jumper_legend',
        name: 'Jumper Legend',
        description: 'Jump 25000 times in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_jumper_legend',
        icon: 'images/badges/jumper_5.png',
      },
    ],
  },
  BOSS_SLAYER_BADGES: {
    ...
    bosses: [
      {
        id: 'glitchzilla_slayer',
        name: 'Glitchzilla Slayer',
        description: 'Defeat Glitchzilla.',
        flag: 'glitchzillaDefeated',
        unlocksSkin: 'skin_donkey_glitchzilla_slayer',
        icon: 'images/badges/glitchzilla_slayer.png',
      },
      {
        id: 'trojan_byte_slayer',
        name: 'Trojan Byte Slayer',
        description: 'Defeat Trojan Byte.',
        flag: 'trojanByteDefeated',
        unlocksSkin: 'skin_donkey_trojan_slayer',
        icon: 'images/badges/trojan_byte_slayer.png',
      },
      {
        id: 'missing_number_slayer',
        name: 'Missing Number Slayer',
        description: 'Defeat Missing Number.',
        flag: 'missingNumberDefeated',
        unlocksSkin: 'skin_donkey_missing_slayer',
        icon: 'images/badges/missing_number_slayer.png',
      },
      {
        id: 'dunno_exe_slayer',
        name: 'DUNNO.EXE Slayer',
        description: 'Defeat DUNNO.EXE.',
        flag: 'dunnoExeDefeated',
        unlocksSkin: 'skin_donkey_dunno_slayer',
        icon: 'images/badges/dunno_exe_slayer.png',
      },
    ],
  },
  CODE_STORMER: {
    ...
    tiers: [
      {
        level: 1,
        threshold: 200,
        id: 'code_shooter_rookie',
        name: 'Code Shooter',
        description: 'Fire 200 shots in a single run.',
        icon: 'images/badges/code_stormer_1.png',
      },
      {
        level: 2,
        threshold: 1000,
        id: 'code_shooter_veteran',
        name: 'Code Barrager',
        description: 'Fire 1000 shots in a single run.',
        icon: 'images/badges/code_stormer_2.png',
      },
      {
        level: 3,
        threshold: 2000,
        id: 'code_shooter_elite',
        name: 'Code Artillery',
        description: 'Fire 2000 shots in a single run.',
        icon: 'images/badges/code_stormer_3.png',
      },
      {
        level: 4,
        threshold: 5000,
        id: 'code_shooter_master',
        name: 'Code Volley',
        description: 'Fire 5000 shots in a single run.',
        icon: 'images/badges/code_stormer_4.png',
      },
      {
        level: 5,
        threshold: 10000,
        id: 'code_shooter_legend',
        name: 'Code Storm',
        description: 'Fire 10000 shots in a single run and unlock a special skin!',
        unlocksSkin: 'skin_bullet_code_storm',
        icon: 'images/badges/code_stormer_5.png',
      },
    ],
  },
  BIT_COLLECTOR: {
    ...
    tiers: [
      {
        ...
        id: 'bit_miner_rookie',
        name: 'Bit Gatherer',
        description: 'Collect 500 bits in a single run.',
        icon: 'images/badges/bit_collector_1.png',
      },
      {
        level: 2,
        threshold: 2500,
        id: 'bit_miner_veteran',
        name: 'Bit Hoarder',
        description: 'Collect 2500 bits in a single run.',
        icon: 'images/badges/bit_collector_2.png',
      },
      {
        level: 3,
        threshold: 5000,
        id: 'bit_miner_elite',
        name: 'Bit Tycoon',
        description: 'Collect 5000 bits in a single run.',
        icon: 'images/badges/bit_collector_3.png',
      },
      {
        level: 4,
        threshold: 10000,
        id: 'bit_miner_master',
        name: 'Bit Baron',
        description: 'Collect 10000 bits in a single run.',
        icon: 'images/badges/bit_collector_4.png',
      },
      {
        level: 5,
        threshold: 20000,
        id: 'bit_miner_legend',
        name: 'Bit Overlord',
        description: 'Collect 20000 bits in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_bit_overlord',
        icon: 'images/badges/bit_collector_5.png',
      },
    ],
  },
  MISSION_EXPERT: {
    ...
    tiers: [
      {
        ...
        threshold: 1,
        id: 'mission_rookie',
        name: 'Mission Apprentice',
        description: 'Complete 1 mission in a single run.',
        icon: 'images/badges/mission_expert_1.png',
      },
      {
        level: 2,
        threshold: 5,
        id: 'mission_veteran',
        name: 'Mission Seeker',
        description: 'Complete 5 missions in a single run.',
        icon: 'images/badges/mission_expert_2.png',
      },
      {
        level: 3,
        threshold: 10,
        ...
        description: 'Complete 10 missions in a single run.',
        icon: 'images/badges/mission_expert_3.png',
      },
      {
        level: 4,
        threshold: 15,
        id: 'mission_master',
        name: 'Mission Maven',
        description: 'Complete 15 missions in a single run.',
        icon: 'images/badges/mission_expert_4.png',
      },
      {
        level: 5,
        threshold: 25,
        id: 'mission_legend',
        name: 'Mission Legend',
        description: 'Complete 25 missions in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_mission_legend',
        icon: 'images/badges/mission_expert_5.png',
      },
    ],
  },
  POWERUP_MASTER: {
    ...
    tiers: [
      {
        level: 1,
        threshold: 10,
        id: 'power_up_apprentice',
        name: 'Power-Up Scavenger',
        description: 'Collect 10 power-ups in a single run.',
        icon: 'images/badges/powerup_master_1.png',
      },
      {
        level: 2,
        threshold: 25,
        ...
        description: 'Collect 25 power-ups in a single run.',
        icon: 'images/badges/powerup_master_2.png',
      },
      {
        level: 3,
        threshold: 50,
        ...
        description: 'Collect 50 power-ups in a single run.',
        icon: 'images/badges/powerup_master_3.png',
      },
      {
        level: 4,
        threshold: 75,
        id: 'power_up_grandmaster',
        name: 'Power-Up Enthusiast',
        description: 'Collect 75 power-ups in a single run.',
        icon: 'images/badges/powerup_master_4.png',
      },
      {
        level: 5,
        threshold: 100,
        id: 'power_up_overlord',
        name: 'Power-Up Overlord',
        description: 'Collect 100 power-ups in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_powerup_overlord',
        icon: 'images/badges/powerup_master_5.png',
      },
    ],
  },
  DATA_PACKET_EXPERT: {
    ...
    tiers: [
      {
        level: 1,
        threshold: 5,
        id: 'data_collector_apprentice',
        name: 'Data Packet Recruiter',
        description: 'Collect 5 data packets in a single run.',
        icon: 'images/badges/data_packet_expert_1.png',
      },
      {
        level: 2,
        threshold: 15,
        id: 'data_collector_expert',
        name: 'Data Packet Analyst',
        description: 'Collect 15 data packets in a single run.',
        icon: 'images/badges/data_packet_expert_2.png',
      },
      {
        level: 3,
        threshold: 30,
        id: 'data_collector_master',
        name: 'Data Packet Engineer',
        description: 'Collect 30 data packets in a single run.',
        icon: 'images/badges/data_packet_expert_3.png',
      },
      {
        level: 4,
        threshold: 50,
        id: 'data_collector_guru',
        name: 'Data Packet Scientist',
        description: 'Collect 50 data packets in a single run.',
        icon: 'images/badges/data_packet_expert_4.png',
      },
      {
        level: 5,
        threshold: 75,
        id: 'data_collector_legend',
        name: 'Data Packet Guru',
        description: 'Collect 75 data packets in a single run and unlock a special skin!',
        unlocksSkin: 'skin_donkey_data_guru',
        icon: 'images/badges/data_packet_expert_5.png',
      },
    ],
  },
  MULTI_FRUIT_EATER: {
    ...
    tiers: [
      {
        level: 1,
        threshold: 10,
        id: 'digital_fruit_collector_1',
        name: 'Fruit Seeker',
        description: 'Collect 10 digital fruits in total.',
        icon: 'images/badges/digital_fruit_collector_1.png',
      },
      {
        level: 2,
        threshold: 50,
        id: 'digital_fruit_collector_2',
        name: 'Fruit Hoarder',
        description: 'Collect 50 digital fruits in total.',
        icon: 'images/badges/digital_fruit_collector_2.png',
      },
      {
        level: 3,
        threshold: 100,
        id: 'digital_fruit_collector_3',
        name: 'Fruit Tycoon',
        description: 'Collect 100 digital fruits in total.',
        icon: 'images/badges/digital_fruit_collector_3.png',
      },
      {
        level: 4,
        threshold: 250,
        id: 'digital_fruit_collector_4',
        name: 'Fruit Baron',
        description: 'Collect 250 digital fruits in total.',
        icon: 'images/badges/digital_fruit_collector_4.png',
      },
      {
        level: 5,
        threshold: 500,
        id: 'digital_fruit_collector_5',
        name: 'Fruit Overlord',
        description: 'Collect 500 digital fruits in total and unlock a special skin!',
        unlocksSkin: 'skin_donkey_fruit_overlord',
        icon: 'images/badges/digital_fruit_collector_5.png',
      },
    ],
  },
  ...
  RAIN_ENEMIES_SLAYER: {
    ...
    tiers: [
      {
        id: 'rain_bug_hunter_rookie',
        level: 1,
        threshold: 100,
        name: 'Rain Bug Hunter Initiate',
        description: 'Debug 100 enemies in a single Rain Run.',
        icon: 'images/badges/rain_debuggator_01.png',
      },
      {
        id: 'rain_bug_hunter_veteran',
        level: 2,
        threshold: 200,
        name: 'Rain Bug Hunter Adept',
        description: 'Debug 200 enemies in a single Rain Run.',
        icon: 'images/badges/rain_debuggator_02.png',
      },
      {
        id: 3,
        level: 3,
        threshold: 350,
        id: 'rain_bug_hunter_expert',
        name: 'Rain Bug Hunter Expert',
        description: 'Debug 350 enemies in a single Rain Run.',
        icon: 'images/badges/rain_debuggator_03.png',
      },
      {
        id: 4,
        level: 4,
        threshold: 500,
        id: 'rain_bug_hunter_master',
        name: 'Rain Bug Hunter Master',
        description: 'Debug 500 enemies in a single Rain Run.',
        icon: 'images/badges/rain_debuggator_04.png',
      },
      {
        id: 5,
        level: 5,
        threshold: 750,
        id: 'rain_bug_hunter_legend',
        name: 'Rain Bug Hunter Legend',
        description: 'Debug 750 enemies in a single Rain Run.',
        icon: 'images/badges/rain_debuggator_05.png',
      },
    ],
  },
  ...
  RAIN_SCORE_MASTER: {
    ...
    tiers: [
      {
        id: 'rain_score_rookie',
        level: 1,
        threshold: 10000,
        name: 'Rain Score Initiate',
        description: 'Reach 10000 points in a single Rain Run.',
        icon: 'images/badges/rain_score_master_1.png',
      },
      {
        id: 'rain_score_veteran',
        level: 2,
        threshold: 20000,
        name: 'Rain Score Enthusiast',
        description: 'Reach 20000 points in a single Rain Run.',
        icon: 'images/badges/rain_score_master_2.png',
      },
      {
        id: 'rain_score_elite',
        level: 3,
        threshold: 30000,
        name: 'Rain Score Artisan',
        description: 'Reach 30000 points in a single Rain Run.',
        icon: 'images/badges/rain_score_master_3.png',
      },
      {
        id: 'rain_score_master',
        level: 4,
        threshold: 50000,
        name: 'Rain Score Grandmaster',
        description: 'Reach 50000 points in a single Rain Run.',
        icon: 'images/badges/rain_score_master_4.png',
      },
      {
        id: 'rain_score_legend',
        level: 5,
        threshold: 75000,
        name: 'Rain Score Legend',
        description: 'Reach 75000 points in a single Rain Run.',
        icon: 'images/badges/rain_score_master_5.png',
      },
    ],
  },
};
  ...
  for (const key in FRONTEND_BADGE_TIERS) {
    ...
    if (category.type === 'individual_boss') {
      category.bosses.forEach((bossBadge) => {
        badgeDefinitionsCache[bossBadge.id] = {
          ...bossBadge,
          isSecret: bossBadge.isSecret || false,
        };
      });
...
export async function getUserBadgesStatus(userId) {
  ...
  if (!currentUserData || currentUserData.userId !== userId) {
    console.warn(
      `getUserBadgesStatus: currentUserData non disponibile o non corrisponde per userId: ${userId}. Usando dati vuoti.`,
    );
...
export async function renderBadges(containerElement, userBadgesStatus) {
  ...
  for (const key in FRONTEND_BADGE_TIERS) {
    ...
    if (category.type !== 'individual_boss' && category.type !== 'multi_fruit_cumulative') {
      // Existing tiered badge logic
      ...
      displayCategories[baseId] = {
        ...
        icon:
          badgeDefFromFirestore?.icon ||
          tierToDisplay?.icon ||
          'images/badges/locked_tiered_badge.png',
        name:
          badgeDefFromFirestore?.name ||
          category.name ||
          (tierToDisplay ? tierToDisplay.name.replace(` Level ${tierToDisplay.level}`, '') : ''),
      ...
      // NEW: Multi-fruit cumulative badge
      ...
      displayCategories[badgeId] = {
        ...
        icon:
          badgeDefFromFirestore?.icon ||
          category.icon ||
          'images/badges/locked_multi_fruit_badge.png', // Fallback icon
      ...
      category.bosses.forEach((bossBadge) => {
        ...
        displayCategories[badgeId] = {
          ...
          icon:
            badgeDefFromFirestore?.icon || bossBadge.icon || 'images/badges/locked_boss_badge.png', // Fallback anche per i boss
  ...
  sortedCategoryKeys.forEach((categoryKey) => {
    ...
    if (item.type === 'tiered') {
      ...
      if (item.currentMaxEarnedLevel > 0) {
        ...
        if (item.nextTierForProgress) {
          ...
          const progressPercentage = Math.min(
            100,
            (actualCurrentValue / nextTierThreshold) * 100,
          ).toFixed(0);
        ...
        const progressPercentage = Math.min(
          100,
          (actualCurrentValue / firstTierThreshold) * 100,
        ).toFixed(0);
    ...
    } else if (item.type === 'multi_fruit_cumulative') {
      // NEW: Multi-fruit cumulative badge display
      isEarnedStatus = item.isEarned;
      badgeCard.className = `badge-card ${isEarnedStatus ? 'earned' : 'locked'}`;
      ...
      if (isEarnedStatus) {
        ...
        const progressPercentage = Math.min(
          100,
          (item.totalProgressCurrent / item.totalProgressThreshold) * 100,
        ).toFixed(0);
        progressHTML = `
                    <div class="badge-progress-bar">
                        <div class="progress-fill" style="width: ${progressPercentage}%"></div>
